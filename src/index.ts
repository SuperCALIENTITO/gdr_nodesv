...
import { APIEmbed, ApplicationCommandDataResolvable, cleanContent, Embed, escapeMarkdown, Events, Guild, Interaction, Message, TextBasedChannel, TextChannel, Webhook } from "discord.js"
...
REST.post("/sendmessage", async (Request, Response): Promise<void> => {
    ...
    GDR.WriteLog(LogType.GMOD, `${MsgInfo[1]}: ${cleanContent(MsgInfo[2], GDR.Webhook.channel as TextBasedChannel)}`);
